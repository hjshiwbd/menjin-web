...
<body>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /STYLER -->
									<div class="clearfix">
										<h3 class="content-title pull-left">密码修改</h3>
									</div>
									<div class="divide-20"></div>
									<div class="description">修改个人密码</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
							...
							<div class="col-md-12">
								...
								<div class="box border primary">
									...
									<div class="row">
										<div class="col-md-12">
											<div class=" col-xs-8">
												<form id="fm1" action="<%=path%>/user/change_mima.html" method="post">
													<div class="form-group">
														<label class="">老密码</label><input type="password" class="form-control" name="oldPassword" id="oldPassword" />
													</div>
													<div class="form-group">
														<label class="">新密码</label><input type="password" class="form-control" name="newPassword" id="newPassword" />
													</div>
													<div class="form-group">
														<label class="">重复新密码</label><input type="password" class="form-control" name="newPassword2" id="newPassword2" />
													</div>
													<div class="form-group">
														<button id="tj" class="btn btn-primary">保存</button>
													</div>
												</form>
											</div>
										</div>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/menjin/user/user_mima.js"></script>
