...
<body>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<div class="description">用户管理</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
										...
										<div class="row">
											<form id="searchForm" class="" action="<%=path%>/dpt/list_eu<%=suffix%>">
												...
												<div class="form-group col-xs-2">
													<label class="col-xs-6">用户名</label><input type="text" class="form-control" id="username" name="username">
												</div>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/menjin/user/user_list.js"></script>
</body>
</html>