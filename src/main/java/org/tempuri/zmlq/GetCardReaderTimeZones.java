 ...
 *         &lt;element name="out-structTimeZone" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetCardReaderTimeZones")
public class GetCardReaderTimeZones {
    ...
    @XmlElementRef(name = "out-structTimeZone", type = JAXBElement.class, required = false)
    protected JAXBElement<String> outStructTimeZone;
     ...
     *     
     */
    public JAXBElement<String> getOutStructTimeZone() {
        return outStructTimeZone;
    }

    /**
     * 设置outStructTimeZone属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setOutStructTimeZone(JAXBElement<String> value) {
        this.outStructTimeZone = value;
    }
